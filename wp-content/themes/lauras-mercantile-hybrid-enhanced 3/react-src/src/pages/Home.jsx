...
<h2 className="lm-section-title">Shop By Health Benefit</h2>
        <div className="lm-kicker">Find the right product for your goals.</div>

        <div className="lm-grid-4" style={{marginTop:18}}>
          {benefits.map((b) => (
            <div className="lm-benefit-card" key={b.title}>
              <div className="lm-benefit-img" />
              <div className="lm-benefit-body">
                <div className="lm-benefit-name">{b.title}</div>
                <Link className="lm-btn secondary" to={b.to} style={{width:'100%'}}>{b.cta}</Link>
              </div>
            </div>
          ))}
        </div>
