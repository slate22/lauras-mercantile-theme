...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    var target = 'https://laurasmercantile.com/agricultural-sustainability-efforts-of-mt-folly-farm/';
    var links = document.querySelectorAll('a[href="/our-approach"], a[href$="/our-approach/"]');
...
<?php if ( function_exists('is_front_page') && is_front_page() ) : ?>
  <div class="lm-promo-banner" role="region" aria-label="Promotion">
    Take 20% off CBD Chocolates and Mushroom Supplements. No coupon required.
  </div>
<?php endif; ?>
